        ...
        <div className="container px-4 mx-auto flex flex-wrap items-center justify-between">
          ...
          >
            ...
            <ul className="flex flex-col lg:flex-row list-none lg:ml-auto">
              <li className="flex items-center">
                  <div className="customdropdown inline-block relative">
                      <button className="0 text-gray-500 font-semibold py-2 px-4 rounded inline-flex items-center">
                        <span className="mr-1">Dropdown</span>
                        <svg className="visible lg:invisible fill-current h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M9.293 12.95l.707.707L15.657 8l-1.414-1.414L10 10.828 5.757 6.586 4.343 8z"/> </svg>
                      </button>
                      <ul className="customdropdown-menu absolute hidden text-gray-700 pt-1">
